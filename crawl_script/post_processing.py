...
# md5_phone_dict = pickle.load(open("../data/my_md5_phone_dict.pkl","rb"))
# %%
    ...
    with open(folder_path + file) as f:
        ...
        for one in f.readlines():
            ...
            if splits[0] in md5_phone_dict.keys():
                ...
                # select_list.append(",".join([md5_phone_dict[splits[0]]] + [splits[-1]]))
...
#%%
with open("../data/律政0206(12月+精筛过滤).csv","w") as f:
